...
JamesHacker/James.py
 @James404-cy-cyber Update James.py
 1 contributor
5
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        if (password == CorrectPassword):
            print "Logged in successfully as " + username #Dev:Fabelt_hacker
	    time.sleep(2)
            loop = 'false'
        else:
...
def menu():
	...
	print "\033[1;97m•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬ •◈•\033[1;93mFabeltMafia\033[1;97m•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬ •◈•"
...
def pilih_super():
	...
	print '\033[1;96m✅Process Has Been Completed Press➡ Ctrl+Z.↩ Next Type (python2 Fabelt.py)↩\033[1;97m....'
